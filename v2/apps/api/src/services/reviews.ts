...
/**
 * Reviews seed — usadas como fallback y mientras no haya Google Places conectado.
 * Si se setea `GOOGLE_PLACES_API_KEY` + `GOOGLE_PLACE_ID`, fetchReviews() consulta
 * la API real, cachea 6h y mezcla con la seed para tener un piso garantizado.
 */
const SEED: Review[] = [
  {
    id: 'seed-1',
